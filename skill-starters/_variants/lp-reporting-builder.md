...
> **Learnings compound.** Before asking diagnostic questions, read `_shared-config/learnings.md`, but only `## General` and `## lp-reporting`. Apply reusable rules. Ignore task history.
