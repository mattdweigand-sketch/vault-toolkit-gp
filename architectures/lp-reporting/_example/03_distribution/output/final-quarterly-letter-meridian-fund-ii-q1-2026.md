# Meridian Fund II — Q1 2026 Letter (FINAL)
Report type: quarterly letter
Fund: Meridian Real Estate Partners, Fund II   Period: Q1 2026
Delivery channel: investor portal
Compliance pass: pass
Per-LP merge: not required (fund-wide letter; distribution detail delivered separately)
...
| Metric | Value |
|---|---|
| Net IRR (since inception) | 14.2% |
| Net multiple (TVPI) | 1.38x |
| Distribution this quarter | $4.2M |
| Called / committed | $182M / $200M |
| NAV | $241M |
...
Multifamily transaction volume is recovering as rate expectations stabilize. The Adler exit
confirmed that well-located, stabilized assets are clearing at strong pricing. Lease-up assets
in softer submarkets, like Cedar Crossing, require more patience.

## What's Next

- Stabilize Cedar Crossing by Q3 2026 under the revised leasing plan.
- Evaluate a refinancing on Brightwater to return capital while holding the asset.
- No capital call is anticipated this quarter.

We appreciate your continued partnership.

Meridian Real Estate Partners

---

*This communication is intended solely for the named investor and contains confidential
information. Past performance is not indicative of future results. This is not an offer to
sell or a solicitation to buy any security. Performance figures are net of fees and carried
interest and are as of March 31, 2026.*
