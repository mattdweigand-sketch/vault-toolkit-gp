...
Build or use a review pass that scores generated output against your standards: your control standards for an operations task, your compliance checklist for an LP communication, your investment criteria for a deal memo. Useful as a second pass: generate the output, then run the reviewer against the spec. The reviewer catches drift you might miss on a quick read. This is the same second-set-of-eyes control the lp-reporting architecture builds into its distribution-stage compliance pass.
